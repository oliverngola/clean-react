import { mockAccountModel, mockSurveyResultModel, LoadSurveyResultSpy, SaveSurveyResultSpy } from '@/tests/domain/mocks'
...
describe('SurveyResult Component', () => {
  ...
  test('Should prevent multiple clicks', async () => {
